...
_TOPOLOGIES_GENERATION_TIME = timedelta(seconds=0).seconds
# TODO: 1 per sec, in real-world 1M per sec, think about that - no need to implement real-world solution.
